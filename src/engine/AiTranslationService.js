...
export const MULTI_DICT = {
  ...
  'doctor attending current patient': { en: 'Doctor attending current patient', hi: 'डॉक्टर वर्तमान मरीज देख रहे हैं', mr: 'डॉक्टर सध्याचे रुग्ण पाहत आहेत', gu: 'ડૉક્ટર હાલના દર્દીને તપાસી રહ્યા છે', ta: 'மருத்துவர் தற்போதைய நோயாளியை கவனிக்கிறார்', te: 'వైద్యులు ప్రస్తుత రోగిని పరిశీలిస్తున్నారు', kn: 'ವೈದ್ಯರು ಪ್ರಸ್ತುತ ರೋಗಿಯನ್ನು ಪರೀಕ್ಷಿಸುತ್ತಿದ್ದಾರೆ', bn: 'ডাক্তার বর্তমান রোগী দেখছেন', pa: 'ਡਾਕਟਰ ਮੌਜੂਦਾ ਮਰੀਜ਼ ਨੂੰ ਦੇਖ ਰਹੇ ਹਨ', ml: 'ഡോക്ടർ നിലവിലെ രോഗിയെ പരിശോധിക്കുന്നു', or: 'ଡାକ୍ତର ବର୍ତ୍ତମାନର ରୋଗୀ ଦେଖୁଛନ୍ତି' },
  'paused (high opd load)': { en: 'Paused (High OPD Load)', hi: 'रोका गया (उच्च ओपीडी भार)', mr: 'थांबवले (जास्त ओपीडी भार)', gu: 'સ્થગિત (ઉચ્ચ ઓપીડી લોડ)', ta: 'நிறுத்தப்பட்டது (அதிக OPD சுமை)', te: 'నిలిపివేయబడింది (అధిక OPD భారం)', kn: 'ವಿರಾಮಗೊಳಿಸಲಾಗಿದೆ (ಹೆಚ್ಚಿನ OPD ಹೊರೆ)', bn: 'স্থগিত (উচ্চ ওপিডি চাপ)', pa: 'ਰੋਕਿਆ ਗਿਆ (ਉੱਚ ਓਪੀਡੀ ਭਾਰ)', ml: 'താൽക്കാലികമായി നിർത്തി (ഉയർന്ന ഒപിഡി ഭാരം)', or: 'ସ୍ଥଗିତ (ଅଧିକ ଓପିଡି ଭାର)' },
};
